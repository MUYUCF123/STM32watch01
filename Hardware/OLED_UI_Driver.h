...
#define Key_GetEnterStatus()    GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_4)
//#define Key_GetBackStatus()     GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_13)
#define Key_GetUpStatus()       GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_1)
#define Key_GetDownStatus()     GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_6)
