...
ColckMenuItems[],SettingTimeItems[],StopWatchMenuItems[],LEDMenuItems[],MPUMenuItems[],GameMenuItems[],DinoGameMenuItems[];
...
,ColckMenuPage,SettingTimeMenuPage,StopWatchMenuPage,LEDMenuPage,MPUMenuPage,GameMenuPage,DinoGameMenuPage;

extern void Show_Battery(void);
#ifdef __cplusplus
}  // extern "C"
#endif
