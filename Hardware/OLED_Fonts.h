...
extern const uint8_t Image_stopwatch[] ;
extern const uint8_t Image_led[] ;
extern const uint8_t Image_mpu[] ;
extern const uint8_t Image_return[] ;
...
extern const uint8_t OLED_UI_LOGOTIME[];
